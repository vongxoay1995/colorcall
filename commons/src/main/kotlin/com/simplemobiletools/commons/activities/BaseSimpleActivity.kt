...
import com.simplemobiletools.commons.extensions.isShowingAndroidSAFDialog
import com.simplemobiletools.commons.extensions.isShowingOTGDialog
import com.simplemobiletools.commons.extensions.isShowingSAFCreateDocumentDialogSdk30
import com.simplemobiletools.commons.extensions.isShowingSAFDialog
import com.simplemobiletools.commons.extensions.isShowingSAFDialogSdk30
        ...
        if (isQPlus()) {
            ...
            Intent(TelecomManager.ACTION_CHANGE_DEFAULT_DIALER).putExtra(TelecomManager.EXTRA_CHANGE_DEFAULT_DIALER_PACKAGE_NAME, packageName).apply {
                try {
                    ...
                    Log.e("TAN", "launchSetDefaultDialerIntent: aaaaa", )
